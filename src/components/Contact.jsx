...
const links = [
  { icon: Mail, label: "kdathwik2024@gmail.com", href: "mailto:kdathwik2024@gmail.com" },
  { icon: GithubIcon, label: "github.com/dathwik", href: "https://github.com/dathwik" },
  { icon: LinkedinIcon, label: "linkedin.com/in/dathwik", href: "https://linkedin.com/in/dathwik" },
];
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-4">
          {links.map(({ icon: Icon, label, href }, i) => (
            <FadeIn key={href} delay={0.3 + i * 0.08}>
              <a
                href={href}
